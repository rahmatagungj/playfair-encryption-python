from generateKeyMatrix import generateKeyMatrix 
from indexLocator import indexLocator 
from convertPlainTextToDiagraphs import convertPlainTextToDiagraphs
...
def main():
    key = input("Enter a key: ").replace(" ", "").upper()
    plainText = input("Enter a plaintext: ").replace(" ", "").upper()
